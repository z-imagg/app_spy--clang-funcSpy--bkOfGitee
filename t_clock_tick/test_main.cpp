...
void GetCurrentThreadIdAsString(std::string& curThreadIdStr){__asm__  __volatile__ (   "jmp 0f \n\t"    "or $0xFFFFFFFF,%%edi \n\t"    "or $0,%%edi \n\t"    "0: \n\t" : : ); /*filePath=/pubx/analyze_code/clang-ctk/t_clock_tick/test_main.cpp, line=28, column=61, funcName=GetCurrentThreadIdAsString*/
  // 获取当前线程的ID
...
void thread1_func(int arg1, char & arg2){__asm__  __volatile__ (   "jmp 0f \n\t"    "or $0xFFFFFFFF,%%edi \n\t"    "or $1,%%edi \n\t"    "0: \n\t" : : ); /*filePath=/pubx/analyze_code/clang-ctk/t_clock_tick/test_main.cpp, line=46, column=41, funcName=thread1_func*/
...
void thread2_func(int k, vector<int> arg2){__asm__  __volatile__ (   "jmp 0f \n\t"    "or $0xFFFFFFFF,%%edi \n\t"    "or $2,%%edi \n\t"    "0: \n\t" : : ); /*filePath=/pubx/analyze_code/clang-ctk/t_clock_tick/test_main.cpp, line=62, column=43, funcName=thread2_func*/
...
int main(int argc, char** argv){__asm__  __volatile__ (   "jmp 0f \n\t"    "or $0xFFFFFFFF,%%edi \n\t"    "or $3,%%edi \n\t"    "0: \n\t" : : ); /*filePath=/pubx/analyze_code/clang-ctk/t_clock_tick/test_main.cpp, line=86, column=32, funcName=main*/
